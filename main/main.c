...
int8_t val()
{
    ...
    voltage = esp_adc_cal_raw_to_voltage(vals, adc_chars);
    //voltage= (vals*(Vmax))/Dmax;
    //printf(" valorleido _%i\n", voltage);
    return voltage;
...
//pin 34
    ...
    //int8_t vals1=esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_6), &adc_chars);
    //voltage1=(adc1_chars.adc_num*(Vmax))/Dmax;
    voltage1=esp_adc_cal_raw_to_voltage(adc1_get_raw(ADC1_CHANNEL_6), &adc_chars);
    return voltage1;

}
//esp_bt_dev_set_device_name("test");

#define CID_ESP 0x02E5
/* Sensor Property ID */
#define SENSOR_PROPERTY_ID_0 0x0059 //present input voltage pin 34
//0x0099
// promedio voltaje     
#define SENSOR_PROPERTY_ID_1 0x005D //present output voltage pin 36
// Present output voltage 0x005D
//0x00B4 
/* 
 * https://github.com/espressif/esp-idf/blob/7bd93e3362e212b1e27fbd19a7a45cbe8e0b46ff/components/bt/esp_ble_mesh/mesh_models/common/include/device_property.h
 */
    ...
    if (event == ESP_BLE_MESH_CFG_SERVER_STATE_CHANGE_EVT)
    {
        ...
        case ESP_BLE_MESH_MODEL_OP_MODEL_APP_BIND:
            ...
            ESP_LOGI(TAG, "elem_addr 0x%04x, app_idx 0x%04x, cid 0x%04x, mod_id 0x%04x",
                     ...
                     if (param->value.state_change.mod_app_bind.model_id == ESP_BLE_MESH_MODEL_ID_SENSOR_SRV)  
                        {
...
void app_main(void)
{
    ...
    //esp_ble_tx_power_set(ESP_BLE_MESH_PROV_ADV | ESP_BLE_MESH_PROV_GATT,ESP_PWR_LVL_P9);
